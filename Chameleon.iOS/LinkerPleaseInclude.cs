...
namespace Chameleon.iOS
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(MvxViewController vc)
        {
            ...
            vc.NavigationController.NavigationBar.SetBackgroundImage(new UIImage(), UIBarMetrics.Default);
        ...
        public void Include(MvvmCross.Plugin.Visibility.MvxVisibilityValueConverter plugin)
        {
            plugin.Convert(null, null, null, null);
        }

        public void Include(MvvmCross.Plugin.Visibility.MvxInvertedVisibilityValueConverter plugin)
        {
            plugin.Convert(null, null, null, null);
        }

        public void Include(Firebase.Core.App app)
        {
